...
function Productdetails() {
  ...
  // const handleBuy = () => {
  //   localStorage.setItem("cart", [...localStorage.getItem("cart"),JSON.stringify(data1)])
  //   router.push("/address");
  // };
  const handleBuy = () => {
  try {
    ...
    const newItem = {
      ...
      ...data1 // Spread remaining properties
    };
    ...
    (data1["verients"]?.length !== 0 &&
      <div>
            ...
            <div className="row header">
              ...
              <div className="col-1" style={{position:"relative"}}>
                    <Link href="/cart" className="_3NH1qf">
                                        ...
                                        <span className="_2tVMo0" style={{position:"absolute",top:-10,right:-14,background:"red",color:"#fff",width:14,height:14,borderRadius:"50%",display:"flex",justifyContent:'center',alignItems:'center'}}>{cartCount}</span>
                                      </Link>
                {/* <div className="menu-icon">
                  <svg
                    width={16}
        ...
        src={ data1[idx === 0 ? "images" : "images" + idx]   }
          ...
          <h5 className='px-3 py-4'><span class="glyphicon glyphicon-tag" style={{color:"green"}}></span><strong> Bank Offer</strong> Get ₹25 instant Cashback on Phone Pe UPI txns on order of ₹250 and above <a href="">T&amp;C</a></h5>
          <div class="delivery-banner">
            <div class="delivery-content">
                <div class="delivery-icon-box">
                    {/* <img src="https://offermania.offerssales.online/assets/images/dd.webp" alt="Delivery Icon" class="delivery-icon"/> */}
                </div>

                <div class="delivery-text-box">
                    <div class="delivery-main">
                        <span class="free-delivery">FREE Delivery</span>
                        <span class="delivery-charge">₹75</span>
                    </div>
                    <div class="delivery-sub">
                        <span class="delivery-label">Delivery by</span>
                        <span class="dot">•</span>
                        <span id="date-display" class="delivery-date">Thursday, Jul 3</span>
                    </div>
                </div>
                <div class="delivery-arrow">
                    <svg width="16" height="16" fill="none" viewBox="0 0 17 17">
                        <path d="M6.627 3.749l5 5-5 5" stroke="#111112" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                </div>
            </div>
        </div>
